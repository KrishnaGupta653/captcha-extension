...
# """
# CRNN CAPTCHA Solver - IMPROVED Training Script with Debugging
# """
...
#     test_split=0.2,
#     save_path='crnn_captcha_model_v3.pth',
...
#     # Print some sample labels for debugging
#     print("\nSample labels (first 5):")
#     for i in range(min(5, len(dataset))):
#         _, label, _, text = dataset[i]
#         print(f"  {text} -> {label.tolist()}")
#     print("-" * 80)
#     print()
...
#     print(f"Num classes (with blank): {num_chars}")
#     print("-" * 80)
#     print()
...
#                     print(f"  Sample {i+1}: Pred='{pred_text}' | True='{label_texts[i]}' | Match={pred_text==label_texts[i]}")
...
def train_crnn_model(
    ...
    for epoch in range(epochs):
        ...
        train_loss, train_acc = train_epoch(
            ...
            device, dataset.idx_to_char, epoch, debug
        )
