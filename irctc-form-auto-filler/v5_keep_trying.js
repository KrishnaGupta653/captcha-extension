...
const TICKET_CONFIG = {
  ...
  // TO_STATION_CODE: "JSME",
  // TO_STATION_FULL: "JASIDIH JN - JSME (JASIDIH)",
  // TRAVEL_DATE: "21/12/2025",
  // TRAIN_CLASS: "All Classes",
  // QUOTA: "TATKAL",
  // TARGET_TRAIN_NUMBER: "22305",
  // PREFERRED_CLASS: "3A",
...
// Retry configuration
const RETRY_CONFIG = {
  SEARCH_BUTTON_INTERVAL: 500, // Try every 500ms
  BOOK_NOW_INTERVAL: 500, // Try every 500ms
  MAX_RETRY_DURATION: 120000, // Stop after 2 minutes
  ERROR_DIALOG_CHECK_INTERVAL: 200, // Check for error dialogs every 200ms
};
